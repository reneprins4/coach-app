...
vi.mock('../training-analysis', () => ({
  analyzeTraining: vi.fn(() => ({
    chest: { setsThisWeek: 6, daysSinceLastTrained: 2, hoursSinceLastTrained: 48, avgRpeLastSession: 7.5, setsLastSession: 4, totalDurationLastSession: 0, recoveryPct: 85, recentExercises: ['Bench Press'], lastSessionSets: [], target: { min: 10, max: 20, mev: 8 }, status: 'ready' },
    back: { setsThisWeek: 8, daysSinceLastTrained: 1, hoursSinceLastTrained: 24, avgRpeLastSession: 8, setsLastSession: 5, totalDurationLastSession: 0, recoveryPct: 60, recentExercises: ['Barbell Row'], lastSessionSets: [], target: { min: 14, max: 22, mev: 10 }, status: 'recovering' },
    shoulders: { setsThisWeek: 4, daysSinceLastTrained: 3, hoursSinceLastTrained: 72, avgRpeLastSession: 7, setsLastSession: 3, totalDurationLastSession: 0, recoveryPct: 95, recentExercises: [], lastSessionSets: [], target: { min: 8, max: 20, mev: 6 }, status: 'ready' },
    quads: { setsThisWeek: 0, daysSinceLastTrained: null, hoursSinceLastTrained: null, avgRpeLastSession: null, setsLastSession: 0, totalDurationLastSession: 0, recoveryPct: 100, recentExercises: [], lastSessionSets: [], target: { min: 12, max: 20, mev: 8 }, status: 'needs_work' },
    hamstrings: { setsThisWeek: 0, daysSinceLastTrained: null, hoursSinceLastTrained: null, avgRpeLastSession: null, setsLastSession: 0, totalDurationLastSession: 0, recoveryPct: 100, recentExercises: [], lastSessionSets: [], target: { min: 10, max: 16, mev: 6 }, status: 'needs_work' },
    glutes: { setsThisWeek: 0, daysSinceLastTrained: null, hoursSinceLastTrained: null, avgRpeLastSession: null, setsLastSession: 0, totalDurationLastSession: 0, recoveryPct: 100, recentExercises: [], lastSessionSets: [], target: { min: 6, max: 16, mev: 4 }, status: 'needs_work' },
    biceps: { setsThisWeek: 4, daysSinceLastTrained: 1, hoursSinceLastTrained: 24, avgRpeLastSession: 7, setsLastSession: 3, totalDurationLastSession: 0, recoveryPct: 70, recentExercises: [], lastSessionSets: [], target: { min: 8, max: 14, mev: 6 }, status: 'recovering' },
    triceps: { setsThisWeek: 4, daysSinceLastTrained: 2, hoursSinceLastTrained: 48, avgRpeLastSession: 7, setsLastSession: 3, totalDurationLastSession: 0, recoveryPct: 90, recentExercises: [], lastSessionSets: [], target: { min: 8, max: 14, mev: 6 }, status: 'ready' },
    core: { setsThisWeek: 2, daysSinceLastTrained: 3, hoursSinceLastTrained: 72, avgRpeLastSession: 6, setsLastSession: 2, totalDurationLastSession: 0, recoveryPct: 100, recentExercises: [], lastSessionSets: [], target: { min: 4, max: 12, mev: 2 }, status: 'ready' },
  })),
  scoreSplits: vi.fn(() => [
